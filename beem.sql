...
CREATE TABLE `table` (
  ...
  `Age` int(11) NOT NULL,
  `Phone_Number` bigint(20) NOT NULL,
  `Any Conditions` tinyint(1) NOT NULL,
...
INSERT INTO `table` (`Name`, `DOBirth`, `Age`, `Phone_Number`, `Any Conditions`, `VaccineDate`) VALUES
('murtda Mohammed Rashid', '2021-07-15', 54, 658000704, 0, NULL),
('murtda Mohammed Rashid', '2021-07-15', 54, 658000704, 0, NULL),
('murtda Mohammed Rashid', '2021-07-15', 54, 658000704, 0, NULL),
('murtda Mohammed Rashid', '2021-07-15', 54, 658000704, 0, NULL),
('murtda Mohammed Rashid', '2021-07-15', 54, 658000704, 0, NULL),
